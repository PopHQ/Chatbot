...
starting_graphics(D) :-
    ...
    send(Chatbot, message, message(@prolog, games_clicked, D, TitleText, CategoryText, ScoreText, Chatbot, Anime, Manga, 0, 0)),
...
geo_clicked(D, TitleText, CategoryText, ScoreText, Chatbot, Anime, Manga, QuestionNumber, CorrectAnswers) :-
    send(D, append, new(MainMenuButton, button('Main Menu', message(@prolog, mainMenu, D)))),
    send(MainMenuButton, center, point(310, 600)),
